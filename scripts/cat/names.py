...
class Name():
    ...
    normal_suffixes = [  # common suffixes
        ...
        'warren', 'water', 'wave', 'weasel', 'weed', 'wheat', 'whistle', 'whistler', 'wiggle', 'willow', 'wither', 'wonder', 'wood', 'wort', 'wound',
    ...
    loner_names = [
        ...
        "Callisto", "Era", "Noro", "Ryos", "Magi", "Lover", "Chrome", "Ryos", "Scribble", "Haunted", "Tailoid", "Noodle Doodle", "Fluffer Puffer"
    ]
