...
eye_sprites = [
    'YELLOW', 'AMBER', 'HAZEL', 'PALEGREEN', 'GREEN', 'BLUE', 'DARKBLUE', 'GREY', 'CYAN', 'EMERALD', 'PALEBLUE', 'PALEYELLOW',
    'GOLD', 'HEATHERBLUE', 'COPPER', 'SAGE', 'BLUE2', 'SUNLITICE', 'GREENYELLOW', 'PINK', 'SCARLET', 'VIOLET', 'PALEYELLOW2',
    'RED', 'AQUA', 'PALEVIOLET', 'SAGEGREEN', 'PALEBLUE2', 'BROWN', 'SPRINGGREEN', 'GOLDEN', 'HONEY', 'COPPER2', 'MAGENTA',
    'MINT', 'EMERALD2', 'PUMPKIN', 'ROSEGOLD', 'DANDELION', 'INDIGO', 'AMARANTH', 'CORAL', 'DARKGREEN', 'DARKAMBER'
